...
,    { id: 1, firstName: "จีรศักดิ์1", lastName: "พิมพ์คำไหล", email: "Oz@gmail.com", dapament: "พนักงาน",   status: "อยุ่" ,phone: "191" },
  ...
  <div className="text-center">
    <p className='text-6xl mt-8 text-neutral-700'>Account</p>
  ...
  <div className="max-w-[80%] mx-auto">
    ...
    <div className="overflow-x-auto">
      <table className="table-auto w-full border-collapse border border-gray-300 mt-4">
        <thead>
          <tr>
            <th className="px-2 py-3 bg-gray-200 border border-gray-300">ID</th>
            ...
            <th className="px-2 py-1 bg-gray-200 border border-gray-300">Email</th>
            <th className="px-2 py-1 bg-gray-200 border border-gray-300">ตำแหน่ง</th>
            <th className="px-2 py-1 bg-gray-200 border border-gray-300">สถานะ</th>
            <th className="px-2 py-1 bg-gray-200 border border-gray-300">เบอร์โทร</th>
            <th className="px-2 py-1 bg-gray-200 border border-gray-300">แก้ไข</th>
