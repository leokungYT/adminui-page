  ...
  <div className="max-w-[80%] mx-auto">
    ...
    <div className="overflow-x-auto">
      <table className="table-auto w-full border-collapse border border-gray-300 mt-4">
        <thead>
          <tr>
            <th className="px-2 py-3 bg-gray-200 border border-gray-300">RecordIN_ID</th>
            ...
            <th className="px-2 py-1 bg-gray-200 border border-gray-300">วัน/เดือน/ปี</th>
        ...
        <tbody>
          <tr>
            ...
            <td className="px-4 py-2 border border-gray-300 text-center">01/01/65</td>
